...
def _conv3x3(in_channels, out_channels, **kwargs):
    ...
    layer = nn.Sequential(nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=1),
                          nn.ReLU())
...
class SegNet2D(nn.Module):
    def __init__(self, n_classes, n_input_channels, scaling_factor, skip='cat'):
        ...
        self.lat = nn.Conv2d(128*scaling_factor, 256*scaling_factor, 
        ...
        self.conv_out = nn.Conv2d(32*scaling_factor, n_classes, kernel_size=1)
